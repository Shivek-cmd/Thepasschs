        ...
        <AnimatedSection className="mb-16 md:mb-20">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              >
                Sandwiches that people<br />
                <em>genuinely</em> talk about.
              </h2>
            </div>
            <Link
              href="/menu"
          ...
          {featured.map((dish) => (
            ...
            >
              ...
              <div className="relative overflow-hidden" style={{ aspectRatio: '4/3' }}>
                <Image
                  src={dish.image}
                  alt={`${dish.name} — artisan sandwich at The Pass Charleston`}
                  fill
                ...
                <span
                  className="absolute top-4 left-4 text-[10px] uppercase tracking-[0.18em] font-semibold px-2.5 py-1 rounded-full"
